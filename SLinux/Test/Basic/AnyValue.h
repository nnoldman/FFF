...
namespace Basic {
    class DefaultValue {
      public:
        ...
        template<> static bool isString(std::string* var) {
            return true;
        }
        ...
        template<> static bool isNumber(char* var) {
            return true;
        }
        template<> static bool isNumber(unsigned char* var) {
            return true;
        }
        template<> static bool isNumber(short* var) {
            return true;
        }
        template<> static bool isNumber(unsigned short* var) {
            return true;
        }
        template<> static bool isNumber(int* var) {
            return true;
        }
        template<> static bool isNumber(unsigned int* var) {
            return true;
        }
        template<> static bool isNumber(int64_t* var) {
            return true;
        }
    };
